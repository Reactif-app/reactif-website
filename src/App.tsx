    ...
    <>
      ...
      <main>
        <section className="hero" id="accueil">
          <div className="hero__visual" role="img" aria-label="Illustration de l'application RéACTIF" />
          <div className="hero__content">
            ...
            <p>
              RéACTIF accompagne les soignants pendant l'intervention en chronométrant automatiquement les délais entre adrénaline,
              cordarone et chocs, afin de réduire la charge mentale et de mieux focaliser l'attention sur le patient.
            </p>
        ...
        <section className="section" id="fonctionnalites" aria-labelledby="fonctionnalites-title">
        ...
        <section className="section" id="histoire" aria-labelledby="histoire-title">
        ...
        <section className="section" id="confidentialite" aria-labelledby="confidentialite-title">
          <p className="eyebrow">Objectif de recherche</p>
          <h2 id="confidentialite-title">Retour d'expérience et confidentialité</h2>
          <div className="grid grid-2">
            <article className="card">
              <h3>Visée de recherche</h3>
              <p>
                RéACTIF vise à faciliter le retour d'expérience afin de perfectionner le déroulement des réanimations cardiaques et
            ...
            <article className="card">
              ...
              <p>
                L'application fonctionne sans Internet, ne collecte aucune donnée médicale ni personnelle et stocke l'historique
                uniquement en local. Les historiques ne contiennent pas de données sensibles.
              </p>
            </article>
          </div>
        </section>
